...
public class Resultado {
    ...
    @ElementCollection
    @CollectionTable(name = "resultado_dezenas_ordem_sorteio",
            joinColumns = {
    ...
    @ElementCollection
    @CollectionTable(name = "resultado_dezenas",
            joinColumns = {
                @JoinColumn(name = "loteria"),
                @JoinColumn(name = "concurso")
            })
    ...
    @ElementCollection
    @CollectionTable(name = "resultado_trevos",
            joinColumns = {
                @JoinColumn(name = "loteria"),
                @JoinColumn(name = "concurso")
            })
    ...
    @ElementCollection
    @CollectionTable(name = "resultado_premiacoes",
            joinColumns = {
                @JoinColumn(name = "loteria"),
                @JoinColumn(name = "concurso")
            })
    ...
    @ElementCollection
    @CollectionTable(name = "resultado_local_ganhadores",
            joinColumns = {
                @JoinColumn(name = "loteria"),
                @JoinColumn(name = "concurso")
            })
    ...
    @ManyToMany
    @JoinTable(name = "resultado_estados_premiados",
            joinColumns = {
                @JoinColumn(name = "loteria"),
                @JoinColumn(name = "concurso")
            },
